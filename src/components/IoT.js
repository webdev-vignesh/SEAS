        ...
        <div className="text-center flex-1 mx-2 my-6">
          ...
          <div className="text-left grid grid-cols-1 md:grid-cols-3 ">
            <ul className="ml-8 mb-4">
              ...
              <li>▪️ Automation and optimization of industrial processes</li>
              <li>▪️ Predictive maintenance and asset tracking</li>
            </ul>            
            <ul className="ml-8">
          ...
          Our team of experts has extensive experience in the IoT field, and we stay up-to-date with the latest technologies and industry trends to ensure that we're providing our clients with the best possible solutions.
        </p>
        </div>
